...
export function ObjectHoverGuides({ size }: ObjectHoverGuidesProps) {
  ...
  const axisGeo = useLineGeometry(axisGeometryPos, [
    1, 0.15, 0.15, 1, 0.15, 0.15,
    0.2, 1, 0.2, 0.2, 1, 0.2,
    0.25, 0.5, 1, 0.25, 0.5, 1,
  ])
  const boxGeo = useLineGeometry(boxGeometryPos)
  ...
  return (
    <group>
      ...
      <lineSegments geometry={boxGeo} position={[0, halfHeight, 0]}>
